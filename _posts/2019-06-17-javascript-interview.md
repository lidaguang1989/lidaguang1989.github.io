一年前写了一篇[JavaScript八张思维导图](https://juejin.im/post/5a6e881af265da3e2f0134e3)，主要是对前端JavaScript知识点的一个系统的整理和总结。本篇文章用了近一个月时间，搜集整理了网上各种面试笔试题及本人针对前端的一些理解以及各路大神针对前端难点部分的详细介绍，可以作为以后面试或者考察面试人员的参考。
...
### JS事件委托、事件冒泡
![](https://user-gold-cdn.xitu.io/2019/6/17/16b63634b0576adb)
...
### JS内存空间的管理
 ...
 - **引用数据类型与堆内存**  
    ...
    ![](https://user-gold-cdn.xitu.io/2019/6/17/16b636391676b162)
...
![](https://user-gold-cdn.xitu.io/2019/6/17/16b6363bf3fbbe55)
...
![](https://user-gold-cdn.xitu.io/2019/6/17/16b6363efe7d62f6)
...
![](https://user-gold-cdn.xitu.io/2019/6/17/16b636409cd20734)
